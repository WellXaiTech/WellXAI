...
// This route is reached by proxy.ts rewriting "/" here on wellxai.world.
// Without force-dynamic, Vercel's edge CDN can cache this page and serve
// that same cached response for other hosts' "/" requests too, since the
// cache key doesn't vary by Host by default -- see the identical note on
// src/app/(marketing)/page.tsx, where this exact bug first showed up.
