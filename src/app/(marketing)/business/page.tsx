export default function BusinessPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 w-full">
      <h1 className="text-3xl font-semibold">WellX AI for Business</h1>
      <p className="mt-4 text-muted">
        Bring ChatGiZa and the WellX API into your company&apos;s workflows — customer
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-3">
        ...
        <div className="card rounded-2xl p-6">
          ...
          <p className="mt-2 text-sm text-muted">
            Connect WellX AI directly into the products and internal systems you already run.
          </p>
        </div>
        <div className="card rounded-2xl p-6">
      ...
      <div className="card mt-12 rounded-2xl p-8 text-center">
        <h2 className="text-lg font-semibold">Want to bring WellX AI to your company?</h2>
        <p className="mt-2 text-sm text-muted">
          Email <span className="text-foreground">hello@wellx.ai</span> and our team will get back to you.
        </p>
      </div>
    </div>
  );
